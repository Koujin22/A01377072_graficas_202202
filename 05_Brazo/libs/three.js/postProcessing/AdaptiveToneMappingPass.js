...
class AdaptiveToneMappingPass extends Pass {
	...
	reset() {
		...
		// renderer.render( this.scene, this.camara, this.luminanceRT );
		// renderer.render( this.scene, this.camara, this.previousLuminanceRT );
		// renderer.render( this.scene, this.camara, this.currentLuminanceRT );
