...
class SSRrPass extends Pass {
	...
	constructor( { renderer, scene, camara, width, height, selects } ) {
		...
		this.ssrrMaterial.uniforms[ 'camaraNear' ].value = this.camara.near;
		this.ssrrMaterial.uniforms[ 'camaraFar' ].value = this.camara.far;
		this.ssrrMaterial.uniforms[ 'resolution' ].value.set( this.width, this.height );
		this.ssrrMaterial.uniforms[ 'camaraProjectionMatrix' ].value.copy( this.camara.projectionMatrix );
		this.ssrrMaterial.uniforms[ 'camaraInverseProjectionMatrix' ].value.copy( this.camara.projectionMatrixInverse );
