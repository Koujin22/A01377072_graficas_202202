 ...
 */
function rotateSceneX(deltax, group)
{
...
function rotateSceneY(deltay, group)
{
    group.rotation.x += deltay / 100;
    document.getElementById('rotation').innerHTML = "rotation: "+group.rotation.x+"," + group.rotation.y.toFixed(1) + ",0";
    window.x = document.getElementById('rotation')
}
